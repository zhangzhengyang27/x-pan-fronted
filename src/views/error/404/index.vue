    ...
    <div class="max-w-md w-full text-center">
      ...
      <div class="relative mb-8">
        <div class="absolute inset-0 flex items-center justify-center">
          <div class="size-72 rounded-full bg-gradient-to-br from-[var(--color-primary-100)] to-transparent dark:from-[var(--color-primary-900)]/30 blur-2xl"/>
        </div>
        <svg
        ...
        >
          ...
          <!-- 行星环 -->
          <ellipse cx="170" cy="50" rx="60" ry="14" stroke="var(--color-primary-300)" stroke-width="1.5" fill="none" opacity="0.6" transform="rotate(-20 170 50)"/>
