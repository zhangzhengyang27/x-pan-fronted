...
<template>
  <div class="min-h-screen flex items-stretch bg-[var(--color-bg)]">
    <!-- 左侧品牌区 -->
    <div
      class="hidden lg:flex flex-col justify-between p-12 lg:w-1/2 bg-gradient-to-br from-[var(--color-primary-600)] to-[var(--color-primary-800)] text-white relative overflow-hidden"
    >
      <!-- 装饰 -->
